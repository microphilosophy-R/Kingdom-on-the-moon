...
export const facilityEconomySpecs: Record<FacilityId, FacilityEconomySpec> = {
  ...
  E2: {
    ...
    requiredTech: 'TE2-0',
    maxLevel: 12,
    baseUpgradeCost: { regolith: 3, alloy: 3, currency: 2, quantumCore: 1 },
    yieldGrowth: 0.07,
    priority: 9,
  ...
  C2: {
    ...
    requiredTech: 'TC2-0',
    maxLevel: 12,
    baseUpgradeCost: { alloy: 3, currency: 3, quantumCore: 1 },
    yieldGrowth: 0.06,
    priority: 8,
  ...
  P: {
    ...
    requiredTech: 'TP-0',
    maxLevel: 12,
    baseUpgradeCost: { water: 4, regolith: 3, alloy: 2, quantumCore: 1 },
    yieldGrowth: 0.05,
    priority: 7,
  ...
  L: {
    ...
    requiredTech: 'TL-0',
    maxLevel: 15,
    baseUpgradeCost: { alloy: 6, currency: 6, quantumCore: 1 },
    yieldGrowth: 0.1,
    priority: 9,
