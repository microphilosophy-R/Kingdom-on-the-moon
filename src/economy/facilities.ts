...
export const facilityEconomySpecs: Record<FacilityId, FacilityEconomySpec> = {
  ...
  R: {
    ...
    productionMethods: [
      { id: 'MR-1', name: '气候改造装置建设', input: { power: 12, water: 1.5, oxygen: 4, biomass: 3, regolith: 6, alloy: 2 }, output: {}, condition: '默认阶段', note: '把公共库存转化为生态工程进度。该阶段大量消耗电力、气体、基质和合金，不产出普通库存资源。' },
  ...
  D: {
    ...
    requiredTech: 'TD-0',
    maxLevel: 10,
    baseUpgradeCost: { alloy: 80, quantumCore: 0.25, currency: 2 },
    yieldGrowth: 0.04,
    priority: 12,
    ...
    productionMethods: [
      { id: 'MD-1', name: '远洋星舰建造', input: { power: 30, water: 3, oxygen: 8, biomass: 6, regolith: 10, alloy: 7 }, output: {}, note: '项目型生产方式。按日消耗电力、合金、氧气和深空补给材料，不产出普通库存资源。实际胜利投入分为三阶段，由星舰界面展示。' },
    ],
    phaseNotes: [
